#ICD-9 cleaner
cleandiagnosis<-function(diagnosistable){
diagnosistable<-diagnosistable[diagnosistable$icd.diagnosis.code!="",] #removes blank ICD-9 codes
...
diagnosistable<-diagnosistable[diagnosis.date<dec2011] #remove rows that have dates outside the area of interest
...
assign(x="dx.id",dx.id,envir=.GlobalEnv)
}
